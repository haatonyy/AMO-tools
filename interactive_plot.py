...
transitions = [
    (0,                                              "red", "6'->5"),
    (127.2,                                          "blue",  "5'->5"),
    (127.2 + 106.0,                                  "green", "4'->5"),
    (127.2 + 251.1,                                  "blue", "5'->4"),
    (127.2 + 106.0 + 251.1,                          "green", "4'->4"),
    (127.2 + 106.0 + 251.1 + 84.8,                  "brown", "3'->4"),
    (127.2 + 106.0 + 251.1 + 201.3,                 "green", "4'->3"),
    (127.2 + 106.0 + 251.1 + 201.3 + 84.8,          "brown", "3'->3"),
    (127.2 + 106.0 + 251.1 + 201.3 + 84.8 + 151.2, "brown", "3'->2"),
]
